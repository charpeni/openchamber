...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.bulkActions.unarchive': '보관 해제',
  'sessions.sidebar.bulkActions.unarchivedSingle': '세션 {count}개 보관 해제됨',
  'sessions.sidebar.bulkActions.unarchivedPlural': '세션 {count}개 보관 해제됨',
  'sessions.sidebar.bulkActions.failedUnarchiveSingle': '세션 {count}개 보관 해제 실패',
  'sessions.sidebar.bulkActions.failedUnarchivePlural': '세션 {count}개 보관 해제 실패',
  ...
  'sessions.sidebar.session.unarchive.success': '세션 보관 해제됨',
  'sessions.sidebar.session.unarchive.pending': '세션 보관 해제 중...',
  'sessions.sidebar.session.unarchive.error': '세션 보관 해제 실패',
