...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.bulkActions.unarchive': '取消封存',
  'sessions.sidebar.bulkActions.unarchivedSingle': '已取消封存 {count} 個會話',
  'sessions.sidebar.bulkActions.unarchivedPlural': '已取消封存 {count} 個會話',
  'sessions.sidebar.bulkActions.failedUnarchiveSingle': '取消封存 {count} 個會話失敗',
  'sessions.sidebar.bulkActions.failedUnarchivePlural': '取消封存 {count} 個會話失敗',
  ...
  'sessions.sidebar.session.unarchive.success': '會話已取消封存',
  'sessions.sidebar.session.unarchive.pending': '正在取消封存會話...',
  'sessions.sidebar.session.unarchive.error': '取消封存會話失敗',
