...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "sessions.sidebar.bulkActions.unarchive": "Desarquivar",
  "sessions.sidebar.bulkActions.unarchivedSingle": "{count} sessão desarquivada",
  "sessions.sidebar.bulkActions.unarchivedPlural": "{count} sessões desarquivadas",
  "sessions.sidebar.bulkActions.failedUnarchiveSingle": "Não foi possível desarquivar {count} sessão",
  "sessions.sidebar.bulkActions.failedUnarchivePlural": "Não foi possível desarquivar {count} sessões",
  ...
  "sessions.sidebar.session.unarchive.success": "Sessão desarquivada",
  "sessions.sidebar.session.unarchive.pending": "Desarquivando sessão...",
  "sessions.sidebar.session.unarchive.error": "Não foi possível desarquivar a sessão",
