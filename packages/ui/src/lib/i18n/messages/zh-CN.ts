...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.bulkActions.unarchive': '取消归档',
  'sessions.sidebar.bulkActions.unarchivedSingle': '已取消归档 {count} 个会话',
  'sessions.sidebar.bulkActions.unarchivedPlural': '已取消归档 {count} 个会话',
  'sessions.sidebar.bulkActions.failedUnarchiveSingle': '取消归档 {count} 个会话失败',
  'sessions.sidebar.bulkActions.failedUnarchivePlural': '取消归档 {count} 个会话失败',
  ...
  'sessions.sidebar.session.unarchive.success': '会话已取消归档',
  'sessions.sidebar.session.unarchive.pending': '正在取消归档会话...',
  'sessions.sidebar.session.unarchive.error': '取消归档会话失败',
